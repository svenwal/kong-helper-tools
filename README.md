...
|------|---------|---------|
| [decK](https://github.com/kong/deck) | 1.65.3 | Declarative configuration management for Kong Gateway (sync, diff, validate configs) |
| [kongctl](https://github.com/kong/kongctl) | 1.14.0| Kong control-plane CLI for AI Gateway workflows |
